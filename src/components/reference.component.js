...
export default class ReferenceComponent extends Component {
    ...
    state = {
        services: [
            {
                icon:<img src={logo} alt="alternative txt" width="220"/>,
                title: "Aciklama",
                // info:"some other things"
            },
            {
                icon:<img src={logo1} alt="alternative txt" width="220"/>,
                // title: "something",
                // info:"some other things"
            },
            {
                icon:<img src={logo2} alt="alternative txt" width="220"/>,
                // title: "something",
                // info:"some other things"
            },
            {
                icon:<img src={logo3} alt="alternative txt" width="220"/>,
                // title: "something",
                // info:"some other things"
            }
        ]
